...
void init_GPIOs(void)
{
     ...
     */
    IfxPort_setPinMode(LED_LEFT, IfxPort_Mode_outputPushPullGeneral);
    IfxPort_setPinMode(LED_RIGHT, IfxPort_Mode_outputPushPullGeneral);
     ...
     */
    IfxPort_setPinMode(BUTTON_LEFT, IfxPort_Mode_inputPullUp);
    IfxPort_setPinMode(BUTTON_RIGHT, IfxPort_Mode_inputPullUp);
}
