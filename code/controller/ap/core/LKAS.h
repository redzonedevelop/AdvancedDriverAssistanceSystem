 ...
 * '<S2>'   : 'LKAS/Low-Pass Filter (Discrete or Continuous)/Enable//disable time constant'
 * '<S3>'   : 'LKAS/Low-Pass Filter (Discrete or Continuous)/Initialization'
 * '<S4>'   : 'LKAS/Low-Pass Filter (Discrete or Continuous)/Integrator (Discrete or Continuous)'
 * '<S5>'   : 'LKAS/Low-Pass Filter (Discrete or Continuous)/Enable//disable time constant/Compare To Constant'
 * '<S6>'   : 'LKAS/Low-Pass Filter (Discrete or Continuous)/Enable//disable time constant/Compare To Zero'
 * '<S7>'   : 'LKAS/Low-Pass Filter (Discrete or Continuous)/Initialization/Init_u'
 * '<S8>'   : 'LKAS/Low-Pass Filter (Discrete or Continuous)/Integrator (Discrete or Continuous)/Discrete'
 */
#endif                                 /* LKAS_h_ */
