...
"hw/driver/motor.o":"hw/driver/motor.src" "hw/driver/subdir.mk"
	astc -I"C:\Users\USER\Downloads\AdvancedDriverAssistanceSystem\code\template\tc275\bsp" -Og -Os --no-warnings= --error-limit=42 -o  "$@" "$<"
"hw/driver/ultrasound.src":"../hw/driver/ultrasound.c" "hw/driver/subdir.mk"
	cctc -cs --dep-file="$*.d" --misrac-version=2004 -D__CPU__=tc27xd -DIFX_GTM=1 "-fC:/Users/USER/Downloads/AdvancedDriverAssistanceSystem/code/template/tc275/TriCore Debug (TASKING)/TASKING_C_C___Compiler-Include_paths__-I_.opt" --iso=99 --c++14 --language=+volatile --exceptions --anachronisms --fp-model=3 -O0 --tradeoff=4 --compact-max-size=200 -g -Wc-w544 -Wc-w557 -Ctc27xd -Y0 -N0 -Z0 -o "$@" "$<"
"hw/driver/ultrasound.o":"hw/driver/ultrasound.src" "hw/driver/subdir.mk"
	astc -I"C:\Users\USER\Downloads\AdvancedDriverAssistanceSystem\code\template\tc275\bsp" -Og -Os --no-warnings= --error-limit=42 -o  "$@" "$<"

clean: clean-hw-2f-driver

clean-hw-2f-driver:
	-$(RM) ./hw/driver/ASCLIN_UART.d ./hw/driver/ASCLIN_UART.o ./hw/driver/ASCLIN_UART.src ./hw/driver/GPIO_LED_Button.d ./hw/driver/GPIO_LED_Button.o ./hw/driver/GPIO_LED_Button.src ./hw/driver/MULTICAN.d ./hw/driver/MULTICAN.o ./hw/driver/MULTICAN.src ./hw/driver/led.d ./hw/driver/led.o ./hw/driver/led.src ./hw/driver/motor.d ./hw/driver/motor.o ./hw/driver/motor.src ./hw/driver/ultrasound.d ./hw/driver/ultrasound.o ./hw/driver/ultrasound.src
